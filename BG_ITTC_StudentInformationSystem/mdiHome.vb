...
Public Class mdiHome
    ...
    Private Sub TraineeToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TraineeToolStripMenuItem.Click

        Dim myForm As New frmTrainee
        myForm.MdiParent = Me
        myForm.Show()
